...
Page({
  ...
  saveFormTodb: function (input_data) {
    ...
    var legal_record_will_by_user = db.collection('legal_record_will_by_user')

    legal_record_will_by_user.add({
      ...
      data: {
        ...
        name: '生后联系人',
        realname: input_data.realname_sheng,
        idnum: input_data.idnum_sheng,
        telnum: input_data.telnum_sheng,
      },
